...
<title>Detail Articles Page | BoomzStore.com - <?php echo $rs[0]['title_th'] ?></title>
			...
			else
			{
				...
				echo"<div class='left_content'>";
					echo"<div class='box_navigator'>";
						echo"<a href='http://www.boomzstore.com/home'>หน้าแรก</a> >> <a href='index'>บทความรีวิว</a> >> <span class='navigator_this_page_color'>".$r{'title_th'}."</span>";
					echo"</div>";
					...
					echo"</div>";	
					echo"<div class='detail_article'>";
						echo"<div class='box_overview_detail'>";
							echo"<div class='box_img_overview'>";
								echo"<div class='visited_img_overview'>";
									echo"<a href='$url_pic' target='_blank'><img src='$url_pic' alt='' title='' width='330' height='248'/></a>";
								echo"</div>";
							echo"<div class='box_list_img_overview'>";
								echo"<a href='$url_pic2' target='_blank'><img src='$url_pic2' alt='' title='' width='87' height='87'/></a>";
								echo"<a href='$url_pic3' target='_blank'><img src='$url_pic3' alt='' title='' width='87' height='87'/></a>";
								echo"<a href='$url_pic4' target='_blank'><img src='$url_pic4' alt='' title='' width='87' height='87'/></a>";
								echo"<br style='clear: both;' />";
							echo"</div>";
						echo"</div>";
						echo"<div class='detail_overview'>";
							echo"<div class='tab_detail_article'>";
								echo"<b>บทบรรยาย (Overview) :</b>";
							echo"</div>";
							echo"<p class='padding_p_article'>".$r{'caption_th'}."</p>";
							echo"</br>";
						echo"</div>";
						echo"<div class='detail_overview'>";
							echo"<div class='tab_detail_article'>";	
								echo"<b>รายละเอียดทั่วไป (Detail) :</b>";	
							echo"</div>";
							echo"<p class='padding_p_article'>".$r{'owner_th'}."</p>";
						echo"</div>";
						echo"<br style='clear: both;' />";	
					echo"</div>";
				echo"</div>";			
				echo"<div class='box_table_specification'>";
					echo"<div class='tab_100percent'>";		
						echo"<b style='margin-left: 10px;'>คุณสมบัติ (Specification) :</b>";	
						echo"<br style='clear: both;' />";
					echo"</div>";
					echo"<div class='detail_info'>";				
						echo"<p class='padding_p_article'>".$r{'content_th'}."</p>";	
						echo"<br style='clear: both;' />";
					echo"</div>";				
				echo"</div>";				  
				echo"<div class='box_detail'>";		
					echo"<div class='tab_100percent'>";
						echo"<b class='text_edittor_review'>บทรีวิวโดยทีมงาน (Profectional Review) :</b>";
						echo"<br style='clear: both;' />";
					echo"</div>";	
					echo"<div class='detail_info'>";				
						echo"<p class='padding_p_article'>".$r{'review_th'}."</p>";	
						echo"<br style='clear: both;' />";
					echo"</div>";
				echo"</div>";		
				echo"<div class='tag_social_button'>";	
					...
					echo"<div class='box_comment'>";
						...
						echo"<div class='fb-comments' data-href='http://www.boomzstore.com/articles/articles_detail_$no_page' data-num-posts='10' data-width='685'></div>";
						echo"<br style='clear: both;' />";
					echo"</div>";
					//$no++;
				}
