...
<title>Login Member | BoomzStore.com - ศูนย์กลางการแบ่งปัน ความรู้ บทความ และการซื้อขายสินค้าไอที ราคาถูก สำหรับคนดิจิตอล</title>
		...
		<div class="box_content">
			...
			<div class="box_content">
				...
				<div class="left_content">
					<div class="box_navigator"><a href="<?php echo base_url(); ?>home">หน้าแรก</a> >> <span class="navigator_this_page_color">เข้าสู่ระบบ</span></div>
	
<div class="box_con_detail">
  <p align="left" class="content_title_bar"><strong>เข้าสู่ระบบสมาชิก BoomzStore.com </strong></p>
  <p align="left">&nbsp;</p>
	<!--------------------------- Login box ------------------------------>
	<p>
		<form method='post' action='<?php echo base_url()?>member/submit_login'>
			<p>ชื่อผู้ใช้งาน : <input type='text' name='email' value=''/>
			รหัสผ่าน : <input type='password' name='password' value=''/> 
			<input type='submit' name='bt' value='เข้าสู่ระบบ'/></p> 
