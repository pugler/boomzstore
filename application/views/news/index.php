			...
			<div class="box_content">
				...
				<div class="left_content">
					...
					<div class="category_it_news">
						...
						<div class="pr_news"><a href="<?php echo base_url(); ?>news/events" class="general_news_text">ข่าวประชาสัมพันธ์</a></div>
						<!--------- this page -------->
				...
				echo"<div class='box_list_detail'>";
					echo"<div class='box_title_list_news'>";
							...
							echo"<div class='title_list_detail'>";
								echo"<h1><a href='http://www.boomzstore.com/news/news_detail_$no_page' target='_blank' class='link_red'>".$r{'title_th'}."</a></h1>";
