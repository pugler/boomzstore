...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('DEFAULT_PATH','../../../../../../../public/'.$_GET['type'].'/'.$_GET['mod']);	
	define('CONFIG_SYS_DEFAULT_PATH', DEFAULT_PATH); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', DEFAULT_PATH);	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 200 * 1024 * 1024 ); //by bytes
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,wma,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl,dtd,flv');
